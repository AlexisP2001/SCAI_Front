  ...
  export default {
    ...
    //  sdsdsdssdsdds
      ...
      columnas: [
        ...
        { text: 'Abono Efectivo', value: 'abonoEfectivo'  ,class:'purple darken-3 white--text'},
        { text: 'Abono Credito', value: 'abonoCredito'  ,class:'purple darken-3 white--text'},
