          ...
          <template v-slot:top>
            <v-toolbar  flat>
              ...
              <v-dialog v-model="dialog"  max-width="500px"  >
                ...
                <v-card >
                <v-card-title><span class="text-h5">Efectivos</span></v-card-title>
                  <v-card-text>
  ...
  export default {
    ...
    //  sdsdsdssdsdds
      ...
      columnas: [
        ...
        { text: 'Subtotal', value: 'subtotal'  ,class:'purple darken-3 white--text'},
        { text: 'Descuento', value: 'descuento'  ,class:'purple darken-3 white--text'},
        { text: 'Total', value: 'total'  ,class:'purple darken-3 white--text'},
        { text: 'Pago Credito', value: 'pagoCredito'  ,class:'purple darken-3 white--text'},
        { text: 'Pago Debito', value: 'pagoDebito'  ,class:'purple darken-3 white--text'},
